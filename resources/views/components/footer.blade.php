...
<footer class="w-full bg-[#004d2e] text-white font-['Plus_Jakarta_Sans',sans-serif]">
    ...
    <div class="w-full px-6 sm:px-12 lg:px-16 py-12 sm:py-16 grid grid-cols-1 md:grid-cols-12 gap-10 lg:gap-12 items-start">
        ...
        <div class="md:col-span-3 space-y-4 text-left">
            <h3 class="text-xl sm:text-2xl font-bold text-[#34d399] tracking-wide">
                Quick Links
            </h3>
            <ul class="space-y-3 text-sm sm:text-base font-semibold text-gray-100">
                <li><a href="{{ url('/') }}" class="hover:text-[#34d399] transition-colors duration-200">Home</a></li>
                <li><a href="{{ url('/about-us') }}" class="hover:text-[#34d399] transition-colors duration-200">About</a></li>
                <li><a href="{{ url('/') }}#services" class="hover:text-[#34d399] transition-colors duration-200">Services</a></li>
                <li><a href="{{ url('/contact-us') }}" class="hover:text-[#34d399] transition-colors duration-200">Get Started</a></li>
            </ul>
        </div>
        ...
        <div class="md:col-span-4 space-y-4 text-left">
            ...
            <ul class="space-y-4 text-sm sm:text-base font-semibold text-gray-100">
                <li class="flex items-center gap-3">
                    ...
                    <a href="tel:+13034724701" class="hover:text-[#34d399] transition-colors duration-200">+1-303-472-4701</a>
                </li>
                <li class="flex items-center gap-3">
                    <svg class="w-5 h-5 text-white shrink-0 fill-current" viewBox="0 0 24 24">
                        <path d="M20 2H4c-1.1 0-1.99.9-1.99 2L2 22l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2zM6 9h12v2H6V9zm8 5H6v-2h8v2zm4-6H6V6h12v2z"/>
                    </svg>
                    <a href="{{ url('/contact-us') }}" class="hover:text-[#34d399] transition-colors duration-200">Send a Message</a>
                </li>
    ...
    <div class="w-full bg-[#1c1c1c] py-4 px-6 sm:px-12 lg:px-16 border-t border-gray-800 text-xs sm:text-sm text-gray-300">
        <div class="w-full flex flex-col sm:flex-row items-center justify-between gap-3 text-center sm:text-left relative">
            ...
            <button 
                ...
                class="absolute right-0 bottom-0 bg-[#002d1b] hover:bg-[#10b981] text-white p-2.5 rounded transition duration-300 shadow-md flex items-center justify-center"
                title="Scroll to Top"
            >
