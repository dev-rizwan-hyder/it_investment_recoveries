                        ...
                        @foreach ($photos as $photo)
                            ...
                            @if ($isImage)
                                <div onclick="window.openImageModal('{{ $photoSrc }}', '{{ $filename }}')" 
                                     class="group relative block aspect-square max-h-36 overflow-hidden rounded-2xl border border-slate-200 bg-slate-50 hover:border-indigo-300 transition cursor-pointer shadow-2xs">
                            ...
                            @else
                                <a href="{{ $photoSrc }}" target="_blank" download="{{ $filename }}" class="group relative flex flex-col items-center justify-center aspect-square max-h-36 rounded-2xl border border-slate-200 bg-slate-50 p-3 text-center hover:border-indigo-300 hover:bg-slate-100/80 transition shadow-2xs">
                                    <i class="fa-solid fa-file-pdf text-3xl text-indigo-500 mb-2 transition duration-300 group-hover:scale-110"></i>
