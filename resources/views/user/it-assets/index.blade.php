...
@section('content')
    <div class="mx-auto max-w-[1600px] px-4 py-6 sm:px-6 lg:px-8 lg:py-10">
        ...
        <section
            ...
            <div class="absolute -bottom-32 right-1/3 h-64 w-64 rounded-full bg-teal-500/10 blur-3xl"></div>

            <div class="relative flex flex-col gap-7 lg:flex-row lg:items-end lg:justify-between">
                <div class="max-w-2xl">
                    <p class="mb-3 text-xs font-bold uppercase tracking-[0.22em] text-indigo-300">Asset Management</p>
                    <h1 class="text-3xl font-black tracking-tight sm:text-4xl">
                        IT Assets
                    </h1>
                    <p class="mt-3 max-w-xl text-sm leading-6 text-slate-300 sm:text-base">
                        Track the inventory, specs, and status of your processed IT equipment and devices.
                    </p>
                </div>
                @if ($client)
                    <div class="shrink-0">
                        <span
                            class="inline-flex items-center gap-1.5 rounded-full bg-white/10 px-3 py-1.5 text-xs font-bold text-indigo-300">
            ...
            <div class="bg-white rounded-[2rem] shadow-sm border border-slate-200/80 overflow-hidden">
                        ...
                        <table class="w-full text-left border-collapse min-w-max">
                            <thead>
                                <tr
                                    ...
                                    <th class="px-8 py-6">Asset Name</th>
                                    ...
                                    <tr class="hover:bg-slate-50/50 transition-colors">
                                        ...
                                        <td class="px-8 py-5 text-right">
                                            <a href="{{ route('user.it-assets.show', $item->id) }}"
                                                class="inline-flex items-center justify-center gap-1.5 rounded-xl border border-slate-200 bg-white px-4 py-2 text-xs font-bold text-slate-700 shadow-sm transition hover:bg-slate-50 hover:text-indigo-600">
                ...
                @else
                    <div class="text-center py-20">
                        ...
                        <h3 class="text-lg font-black text-slate-900">No IT assets found</h3>
                        <p class="mt-2 text-slate-600">
                            There are no IT assets items for your organization at this time.
                        </p>
                    </div>
                @endif
            </div>
